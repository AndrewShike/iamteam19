...
<link rel="stylesheet" href="/iamteam19/wp-content/themes/chicagoculture/journey-style.css" media="screen, print" >
		...
		<div class="et_pb_fullwidth_header_container left">
			<div class="header-content-container center">
				<div class="header-content">
					...
					<h2 class="entry-title main_title">Discover <?php the_title(); ?></h2>	
	...
	<div class="container">
		<div id="content-area" class="clearfix">
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					if( $posts ): ?>
					    ...
					    <?php foreach( $posts as $post): // variable must be called $post (IMPORTANT) ?>
					        ...
					        <hr>
								<button class="accordion"><li><h3 class="place-title"><?php the_field('place_title'); ?></h3></li><img class="accordion-arrow" src="<?php echo get_stylesheet_directory_uri(); ?>/../../uploads/2019/03/pinktriangle-upsidedown1-5.png"/></button>
								<div class="panel">
									...
									<?php if (get_field('place_website')): ?>
										<p><img src="http://goodspark.com/iamteam19/wp-content/uploads/2019/03/icon-www.png" alt=""/> <a href="<?php the_field('place_website'); ?>" style="color: #DF1A82" target="_blank"><?php the_field('place_website'); ?></a></p>
									<?php endif; ?>	
			...
			<?php endwhile; ?>
					...
					<?php if (get_field('journey_map')): ?>
						<div class="google-maps">
							<?php the_field('journey_map'); ?>	
						</div>
					<?php endif; ?>

</div> <!-- #main-content -->
<?php
wp_enqueue_script( 'journey', '/wp-content/themes/chicagoculture/journey.js', true);
?>
<?php
